...
public static void main(String[] args) {
        ...
        System.out.printf("월: %d%n", birthmonth);
        System.out.printf("일: %d%n", birthday);

        System.out.printf("안녕하세요. 저는 %s이고, 생일은 %d월 %d일 입니다.%n", name, birthmonth, birthday);
